...
import DetailsScreenViewController from './../DetailScreen/DetailsScreenViewController';
const wait = (timeout) => {
      ...
      <FlatList
        ...
        renderItem={({item, index}) => (
          <MiniCard
            ...
            icon={true}
            onPress={() => {
              setSelectedItem(item), setComplateLookModal(true);
            }}
          />
        )}
      ...
      <FlatGrid
        ...
        renderItem={({item, index}) => (
          <Card
            ...
            onPress={() => {
              props.navigation.navigate('DetailScreen', {item, from: 'Shirt'});
            }}
          />
        )}
      />
...
export default connect(null, mapDispatchToProps)(DenimShirtViewController);
