...
const HomeStackScreen = ({navigation}) => (
  <HomeStack.Navigator initialRouteName={'Shirt'}>
    <HomeStack.Screen
      name="Shirt"
...
const CategoriesStackScreen = ({navigation}) => (
  <CategorieStack.Navigator initialRouteName={'Categories'}>
        ...
        options={{
          ...
          tabBarIcon: ({focused}) => (
            <Image
              source={
                focused
                  ? require('../images/icons/icon-home.png')
        ...
        options={{
          ...
          tabBarIcon: ({focused}) => (
            <Image
              source={
                focused
                  ? require('../images/icons/icon-category.png')
                  : require('../assets/icons/inactivecate.png')
              }
              style={{
                height: 21.22,
                width: 21.5,
        ...
        options={{
          ...
          tabBarIcon: ({focused}) => (
            <Image
              source={
                focused
                  ? require('../images/icons/icon-user.png')
                  : require('../assets/icons/inactiveuser.png')
              }
              style={{
                height: 23.22,
                width: 21.5,
